...
- 20+ years of technical repair expertise
- CompTIA A+ certified

## What I Focus On

- Building scalable, maintainable applications
- Working across backend, frontend, and infrastructure
- Improving performance, reliability, and developer workflows
- Collaborating with teams on architecture and delivery
...
![Telerik](https://img.shields.io/badge/Telerik-FF6358?style=for-the-badge&logo=telerik&logoColor=white)
...
![Qwen](https://img.shields.io/badge/Qwen-6F5CE5?style=for-the-badge&logo=alibabadotcom&logoColor=white)
...
### Microsoft
![Power Platform](https://img.shields.io/badge/Power_Platform-742774?style=for-the-badge&logo=microsoftpowerplatform&logoColor=white)
...
- Product teams that value quality and speed
- Engineers who care about clean architecture and mentorship
- Cross-functional collaboration between development, operations, and support
- Projects where technical depth and real-world problem solving matter
...
1. Backend APIs and services (Node.js, .NET, Python)
2. Frontend web applications (React, TypeScript, JavaScript)
3. Databases and data modeling (PostgreSQL, MySQL, MongoDB)
4. Containers and deployment workflows (Docker, Linux)
5. Troubleshooting, repair, and system reliability operations

## Professional Snapshot

- Strong mix of software engineering and hands-on technical operations
- Long-term experience diagnosing, fixing, and optimizing systems
- Comfortable owning delivery from idea to production
- Focused on practical, robust, and maintainable solutions
...
You can reach me through GitHub discussions, issues, or direct profile contact options.
